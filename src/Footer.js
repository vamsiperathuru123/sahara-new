    ...
    return(
        <div className="footerarea">
           ...
           <div className='footer_down'>
               ...
               <Link  className='footer_mail'>sahara.pcv@gmail.com</Link><p className='footer_mail'>| All rights are reserved | &copy;{new Date().getFullYear()},saharagadgets.netlify.app|</p>
           </div>
